...
export default function OffersPage() {
    ...
    useEffect(() => {
        ...
        axios.get(`${axiosPath}/key_offers/allOffers`, { params: { userId: userData.id, userRole: userData.role } })
            .then((res) => {
                console.log("Oferty załadowane dla roli:", userData.role, res.data);
