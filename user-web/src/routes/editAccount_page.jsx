...
export default function Root() {
  ...
  const [WhatHeWantsToChange, changeChange] = useState(0);
  ...
  function AddUserToService() {
    ...
    if(currentValidationResult == true){
      ...
      axios.post(`${axiosPath}/users/updateUser`, {
        id: newUser.id,
        login: newUser.login,
        pass: newUser.pass,
        phone: newUser.phone,
  ...
  function CheckIfDataIsGood() {
    if(WhatHeWantsToChange == 1){
      console.log(WhatHeWantsToChange);
    ...
    <div className="container-fluid">
      ...
      <div className='row m-1 text-center font'>
          ...
          <div>
            ...
            <select onChange={(e) => {changeChange(e.target.value); console.log(e.target.value)}}>
              <option disabled selected value>Wybierz jaką chcesz wykonać akcję</option>
